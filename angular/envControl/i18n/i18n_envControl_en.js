asterics.i18n_envControl_en = {
    ...
    i18n_ec_plug: 'Plug',
    i18n_ec_ircmdgeneric: 'Remote-commands',
    i18n_ec_ircmdgeneric_tooltip: 'Learn single remote-commands',
    i18n_ec_irgeneric_tooltip: 'Learn commands of a remote device',
    ...
    i18n_ec_irmass_header_pluggeneric: 'Control new device via plug',
    i18n_ec_irmass_header_irgeneric: 'Add a new remote control device',
    i18n_ec_irmass_header_ircmdgeneric: 'Add new remote control commands',
    ...
    i18n_ec_ir_learn_instruction: 'Please insert the name of the command and press the appropriate button on the remote control afterwards (<b>the remote control needs to point towards the {{hardware}}</b>). After adding at least one command, you can select "Finish" to complete learning or add another command.',
    i18n_ec_ir_command: 'Command',
    ...
    i18n_ec_you_need_devices_singular: 'The following hardware is recommended to control this device:',
    ...
    i18n_ec_install_irtrans_p24: '<i>Hint:</i> on slow computers it can take up to some minutes until the installation is starting.',
    i18n_ec_install_irtrans_p25: '<i>Hint:</i> if an error occurs see',
    ...
    i18n_ec_install_irtrans_p41: '<b>Connect IrTrans to your computer</b> - Connect the IrTrans to your PC using a USB cable (type A-B, see',
    i18n_ec_install_irtrans_p42: 'to the computer.',
    ...
    i18n_ec_install_irtrans_p71: '<i>Hint:</i> if test is not successful immediately after opening "IrTransServer USB", wait a minute and try it again.',
    i18n_ec_test: 'Test',
    i18n_ec_testing: 'Testing...',
    i18n_ec_test_failed: 'Test failed',
    i18n_ec_test_success1: 'Test successful. Please select',
    i18n_ec_test_success2: 'to set up a control.',
    ...
    i18n_ec_check_installed: 'Checking if {{hardware}} is already installed',
    i18n_ec_already_installed1: '{{hardware}} is already correctly installed. Click on',
    i18n_ec_already_installed2: 'to set up a new control.',
    ...
    //help install menu
    i18n_ec_helpinstall_header: 'Hardware installation',
