...
ant deploy -Dfx.deploy.nativeBundles=deb -DARE.baseURI=./AsTeRICS/bin/ARE/ -DAPE.embedJava="false" -Dfx.application.version=$VERSION -Dfx.application.name=asterics-ergo
